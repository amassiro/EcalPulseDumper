...
#process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:phase1_2021_realistic', '') # ---> this is MC: phase1_2021_realistic
#process.GlobalTag = GlobalTag(process.GlobalTag, '111X_mcRun3_2021_realistic_v8', '') # ---> this is MC: phase1_2021_realistic
...
#process.GlobalTag = GlobalTag(process.GlobalTag, '122X_mcRun3_2021_realistic_v1', '') # ---> this is MC: phase1_2021_realistic
#process.GlobalTag = GlobalTag(process.GlobalTag, '101X_dataRun2_HLT_v7', '') #  from https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideFrontierConditions#Global_Tags_for_2018_data_taking
#process.GlobalTag = GlobalTag(process.GlobalTag, '110X_dataRun3_HLT_v1', '') #  from https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideFrontierConditions#Global_Tags_for_2018_data_taking

#process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:run3_hlt', '') # ---> this is data    --->  https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT
#process.GlobalTag = GlobalTag(process.GlobalTag, '122X_dataRun3_HLT_v1', '') # ---> this is data    --->  https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT
#   --> 122X_dataRun3_HLT_v1
#      Unable to find plugin 'EcalTPGOddWeightGroupRcd@NewProxy' in category 'CondProxyFactory'. Please check spelling of name.
#   https://cms-conddb.cern.ch/cmsDbBrowser/list/Prod/gts/122X_dataRun3_HLT_v1
#   https://github.com/cms-sw/cmssw/blob/master/Configuration/AlCa/python/autoCond.py

#process.GlobalTag = GlobalTag(process.GlobalTag, '122X_dataRun2_HLT_relval_v1', '') # ---> this is data    --->  https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT


#process.GlobalTag = GlobalTag(process.GlobalTag, '113X_dataRun3_HLT_v1', '') # ---> this is data    --->  https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT


#
# Fix for error "EcalTPGOddWeightGroupRcd@NewProxy"
#
#process.GlobalTag.toGet = cms.VPSet(
...
#process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:run2_data', '') # ---> this is data    --->  https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT
# does not work

#process.GlobalTag = GlobalTag(process.GlobalTag, '113X_dataRun3_HLT_v3', '') # ---> this is data    --->  by Francesco Brivio
#      Unable to find plugin 'EcalTPGOddWeightGroupRcd@NewProxy' in category 'CondProxyFactory'. Please check spelling of name.
#--->  tutte cose aggiunte nel LS2 ...
#


#
# CMSSW_11_3_0_pre5 --> 110X_dataRun3_HLT_v1
#
...
process.ecalUncalibRecHitProducerGPU.recHitsLabelEB = cms.string('EcalUncalibRecHitsEBfromGPUatGPU')
process.ecalUncalibRecHitProducerGPU.recHitsLabelEE = cms.string('EcalUncalibRecHitsEEfromGPUatGPU')
...
process.ecalCPUUncalibRecHitProducer.recHitsInLabelEB = cms.InputTag("ecalUncalibRecHitProducerGPU","EcalUncalibRecHitsEBfromGPUatGPU")
process.ecalCPUUncalibRecHitProducer.recHitsInLabelEE = cms.InputTag("ecalUncalibRecHitProducerGPU","EcalUncalibRecHitsEEfromGPUatGPU")
process.ecalCPUUncalibRecHitProducer.recHitsOutLabelEB = cms.string('EcalUncalibRecHitsEBfromGPUatCPU')
process.ecalCPUUncalibRecHitProducer.recHitsOutLabelEE = cms.string('EcalUncalibRecHitsEEfromGPUatCPU')
...
process.ecalUncalibRecHitConvertGPU2CPUFormat.recHitsLabelGPUEB = cms.InputTag('ecalCPUUncalibRecHitProducer','EcalUncalibRecHitsEBfromGPUatCPU')
process.ecalUncalibRecHitConvertGPU2CPUFormat.recHitsLabelGPUEE = cms.InputTag('ecalCPUUncalibRecHitProducer','EcalUncalibRecHitsEEfromGPUatCPU')
...
process.ecalUncalibRechitGPUAnalyzer.cpuEBUncalibRecHitCollection = cms.InputTag("ecalMultiFitUncalibRecHit","EcalUncalibRecHitsEB")
process.ecalUncalibRechitGPUAnalyzer.cpuEEUncalibRecHitCollection = cms.InputTag("ecalMultiFitUncalibRecHit","EcalUncalibRecHitsEE")
process.ecalUncalibRechitGPUAnalyzer.gpuEBUncalibRecHitCollection = cms.InputTag("ecalCPUUncalibRecHitProducer","EcalUncalibRecHitsEBfromGPUatCPU")
process.ecalUncalibRechitGPUAnalyzer.gpuEEUncalibRecHitCollection = cms.InputTag("ecalCPUUncalibRecHitProducer","EcalUncalibRecHitsEEfromGPUatCPU")
...
#process.ecalCPUUncalibRecHitProducer = cms.EDProducer("EcalCPUUncalibRecHitProducer",
    #containsTimingInformation = cms.bool(False),
    #mightGet = cms.optional.untracked.vstring,
    #recHitsInLabelEB = cms.InputTag("ecalUncalibRecHitProducerGPU","EcalUncalibRecHitsEBfromGPUatGPU"),
    #recHitsInLabelEE = cms.InputTag("ecalUncalibRecHitProducerGPU","EcalUncalibRecHitsEEfromGPUatGPU"),
    #recHitsOutLabelEB = cms.string('EcalUncalibRecHitsEBfromGPUatCPU'),
    #recHitsOutLabelEE = cms.string('EcalUncalibRecHitsEEfromGPUatCPU')
#)
